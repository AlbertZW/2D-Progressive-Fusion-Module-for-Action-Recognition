...
def return_kinetics(modality):
    ...
    if modality == 'RGB':
        # root_data = '/data/Disk_C/Kinetics400_Resources/kinetics400-frames/'
        # filename_imglist_train = 'kinetics-400/kinetics_train_videofolder.txt'
        # filename_imglist_val = 'kinetics-400/kinetics_val_videofolder.txt'
        root_data = '/data/Disk_D/Video_Data/kinetics-600-frames/'
